# Generated by Django 5.2.4 on 2025-08-29 12:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='farmer',
            name='interview_date',
            field=models.DateField(default=django.utils.timezone.now, verbose_name='Date of interview'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='farmer',
            name='interviewer_name',
            field=models.CharField(default='None', max_length=100, verbose_name='Interviewer name'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='farmer',
        ...
        migrations.AddField(
            model_name='farmer',
            name='marital_status',
            field=models.CharField(choices=[('single', 'Single'), ('married', 'Married'), ('widowed', 'Widowed'), ('divorced', 'Divorced')], default='None', max_length=10, verbose_name='Marital Status'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='farmer',
